...
public class Constants {
    ...
    public static final String CONSUMER_KEY = "15FUSwjlqZ36sMa1H5sKY8oLa";
    public static final String CONSUMER_SECRET = "lrqueefF8zJJL8dXpsfwEcP4cWHfcCNi7pToeHXG0d6ZGMRxOf";
